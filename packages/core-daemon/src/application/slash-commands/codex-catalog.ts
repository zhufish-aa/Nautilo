...
export const CODEX_SLASH_COMMANDS: readonly SlashCommandDefinition[] = [
  { id: "codex.help", name: "/help", aliases: ["/?"], title: "帮助", description: "查看 Nautilo 当前支持的 Codex 会话指令", icon: "help", availability: "always" },
  ...
  { id: "codex.rename", name: "/rename", aliases: ["/title"], title: "重命名会话", description: "修改当前 Nautilo 与 Codex 会话标题", icon: "rename", availability: "always", argumentHint: "新标题" },
